...
function _applyRoleUI() {
  ...
  if (_role === 'admin' || _role === 'plp') {
    ...
    ['ni-mhs-ext','ni-inv','ni-pem','ni-pay','ni-user','ni-export','ni-audit','ni-maint','ni-waste','nl-admin-label','ni-loker','ni-denah']
    ...
    ['ni-mhs-ext','ni-inv','ni-export','ni-audit','ni-maint','ni-waste','nl-admin-label','ni-dosen','ni-loker','ni-denah']
      .forEach(function(id){ var el=document.getElementById(id); if(el) el.classList.remove('hidden'); });
    ...
    ['ni-req','ni-ret','ni-pay','ni-inv','ni-denah'].forEach(function(id){ var el=document.getElementById(id); if(el) el.classList.remove('hidden'); });
...
function goTo(sec) {
  ...
  var titleMap = {
    ...
    'loker'          : 'Manajemen Loker',
    'denah'          : 'Denah Meja Kerja'
  };
  ...
  } else if (sec === 'loker') { // >>> LOKER: denah & manajemen loker
    var el = document.getElementById('sec-loker'); if(el) el.classList.remove('hidden');
    loadLoker();

  } else if (sec === 'denah') { // >>> DENAH: denah meja kerja (lihat = semua role, edit = admin/plp)
    var el = document.getElementById('sec-denah'); if(el) el.classList.remove('hidden');
    loadDenahMeja();
  }
}
...
async function doLogout() {           // ← ubah jadi async
  ...
  [
    ...
    'ni-survei','nl-admin-label','nl-survei-label','ni-loker','ni-denah'
